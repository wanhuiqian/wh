...
function imgchange(){
	...
	$(".div4-1 img")[0].src="../images/lidiv3-"+ord+".jpg";
}
var mysetInterval;
...
$(function(){
	$(".div4-2 img").click(
		function(){
			$(this).click(function(){
			var str=$(this).index();
			$(".div4-1 img")[0].src="../images/lidiv3-"+(str+1)+".jpg";
			stopImg();
			imgchange(str);
			});
...
//---------------------------五版动画-----------------------------
$(function(){
		$(".div5-2 li").click(function(){
				$(this).click(function(){
						var str=$(this).index();
						$(".div5-zong .div5-3").hide();
						$(".div5-zong .div5-3").eq(str).show();
					});
			});
	})